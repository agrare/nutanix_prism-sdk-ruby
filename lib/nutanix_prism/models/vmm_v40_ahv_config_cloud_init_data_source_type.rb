...
module NutanixPrism
  class VmmV40AhvConfigCloudInitDataSourceType
    ...
    def build_from_hash(value)
      return value if VmmV40AhvConfigCloudInitDataSourceType.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #VmmV40AhvConfigCloudInitDataSourceType"
    end
  end
end
