...
module NutanixPrism
  ...
  class PrismV40ManagementBackupTarget
    ...
    attr_accessor :backup_pause_reason
    ...
    def self.openapi_types
      {
        ...
        :'location' => :'PrismV40ManagementBackupTargetAllOfLocation',
        :'last_sync_time' => :'Time',
        :'is_backup_paused' => :'Boolean',
        :'backup_pause_reason' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `NutanixPrism::PrismV40ManagementBackupTarget` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `NutanixPrism::PrismV40ManagementBackupTarget`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'backup_pause_reason')
        self.backup_pause_reason = attributes[:'backup_pause_reason']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          backup_pause_reason == o.backup_pause_reason
    end
    ...
    def hash
      [tenant_id, ext_id, links, location, last_sync_time, is_backup_paused, backup_pause_reason].hash
    end
